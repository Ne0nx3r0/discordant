...
export default new ItemUsable({
    ...
    hiddenDescription: 'After a chance encounter a healer discovered a method of using wish stones to create liquid healing. It was only a matter of time before savvy investors capitalized on the art.',
